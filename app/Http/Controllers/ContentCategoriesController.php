...
use App\Http\Requests\StoreContentCategoriesRequest;
use App\Http\Requests\UpdateContentCategoriesRequest;
...
class ContentCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content_categories.index', compact('content_categories'));
    }
    ...
    public function create()
    {
        ...
        return view('content_categories.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('content_categories.edit', compact('content_category'));
    }
    ...
    public function show($id)
    {
        ...
        return view('content_categories.show', compact('content_category') + $relations);
    }
