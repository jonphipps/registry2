...
@section('content')
    ...
    {!! Form::model($content_page, ['method' => 'PUT', 'route' => ['content_pages.update', $content_page->id], 'files' => true,]) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($content_page->featured_image)
                        <a href="{{ asset('uploads/'.$content_page->featured_image) }}" target="_blank"><img src="{{ asset('uploads/thumb/'.$content_page->featured_image) }}"></a>
                    @endif
