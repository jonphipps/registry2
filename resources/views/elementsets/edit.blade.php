...
@section('content')
    ...
    {!! Form::model($elementset, ['method' => 'PUT', 'route' => ['elementsets.update', $elementset->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('members[]', $members, old('members') ? old('members') : $elementset->members->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
