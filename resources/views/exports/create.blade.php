...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['exports.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('excude_deprecated', 1, true) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('include_generated', 1, true) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('include_deleted', 1, true) !!}
                    <p class="help-block"></p>
