    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-xs-12 form-group">
                ...
                @elseif(isset($user))
                    {!! Form::text('receiver', old('receiver', $user ?? ''), ['class' => 'form-control', 'disabled']) !!}
                @endif
            </div>
            ...
            <div class="col-xs-12 form-group">
                ...
                @if(!isset($user))
                    {!! Form::text('subject', old('subject', $topic->subject ?? ''), ['class' => 'form-control']) !!}
                @else
                    {!! Form::text('subject', old('subject', $topic->subject ?? ''), ['class' => 'form-control', 'disabled']) !!}
                @endif
