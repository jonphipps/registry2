...
@section('content')
    ...
    {!! Form::model($product_category, ['method' => 'PUT', 'route' => ['product_categories.update', $product_category->id], 'files' => true,]) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($product_category->photo)
                        <a href="{{ asset('uploads/'.$product_category->photo) }}" target="_blank"><img src="{{ asset('uploads/thumb/'.$product_category->photo) }}"></a>
                    @endif
