...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['properties.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('in_create', 1, true) !!}
                    <p class="help-block"></p>
