...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['releases.store']]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('sha', 'SHA', ['class' => 'control-label']) !!}
                    {!! Form::text('sha', old('sha'), ['class' => 'form-control', 'placeholder' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('tag', old('tag'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('tag'))
                        <p class="help-block">
                            {{ $errors->first('tag') }}
