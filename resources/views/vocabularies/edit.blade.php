...
@section('content')
    ...
    {!! Form::model($vocabulary, ['method' => 'PUT', 'route' => ['vocabularies.update', $vocabulary->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('members[]', $members, old('members') ? old('members') : $vocabulary->members->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
